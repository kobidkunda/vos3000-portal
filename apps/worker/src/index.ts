...
const iso=(v:unknown,required=false)=>{if(v===null||v===undefined||v==="")return required?undefined:null;const d=new Date(String(v));if(Number.isNaN(d.getTime()))return undefined;const s=d.toISOString();return s.slice(0,23).replace("T"," ");};
