...
Single payment record and receipt.
...
|---|---|---|
| F01 | Processor reference | Required |
| F02 | VOS/portal transaction reference | Required |
| F03 | amount/currency | Required |
| F04 | fees | Required |
| F05 | credited amount | Required |
| F06 | created/completed time | Required |
| F07 | status timeline | Required |
| F08 | balance after credit | Required |
| F09 | download receipt | Required |
| F10 | support link | Required |
...
**Left**
- Page title: **Payment Detail / Receipt**
...
- `page_viewed` with page=`payment-detail-receipt` and side=`client`.
