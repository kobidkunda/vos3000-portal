...
Traffic/spend/quality by destination.
...
|---|---|---|
| F01 | Country/area/prefix | Required |
| F02 | calls | Required |
...
| F07 | PDD | Required |
| F08 | trend | Required |
| F09 | rate lookup shortcut | Required |

## VOS / Product Basis

Area prefix/name and CDR data are documented in VOS; aggregation is [HYBRID].
...
**Left**
- Page title: **Destination Analytics**
...
- `page_viewed` with page=`destination-analytics` and side=`client`.
