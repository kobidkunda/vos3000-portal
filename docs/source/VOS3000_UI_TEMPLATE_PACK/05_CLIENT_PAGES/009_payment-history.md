...
| F04 | method | Required |
| F05 | status | Required |
| F06 | balance after payment when available | Required |
| F07 | reference/serial | Required |
| F08 | receipt | Required |
| F09 | filters and export | Required |
| F10 | exclude internal-only operator notes | Required |

## VOS / Product Basis

VOS Payment Record documents account, payment amount, balance after payment, type, time, mode and serial. [HYBRID]
...
- `page_viewed` with page=`payment-history` and side=`client`.
