...
Conversation and status for one ticket.
...
|---|---|---|
| F01 | Message thread | Required |
| F02 | status/priority | Required |
| F03 | assigned team if exposed | Required |
| F04 | attachments | Required |
| F05 | linked CDR/gateway | Required |
| F06 | reply | Required |
| F07 | close/reopen where policy allows | Required |
...
- `page_viewed` with page=`ticket-detail` and side=`client`.
