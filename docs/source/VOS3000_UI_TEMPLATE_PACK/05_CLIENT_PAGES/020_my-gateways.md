...
Customer-owned gateway inventory.
...
|---|---|---|
| F01 | Gateway name | Required |
| F02 | configured/registered IP | Required |
| F03 | online status | Required |
| F04 | active calls vs line limit | Required |
| F05 | CPS | Required |
| F06 | ASR | Required |
| F07 | ACD | Required |
| F08 | last registration/update | Required |
| F09 | network quality badge | Required |
| F10 | open details | Required |
| F11 | Add Gateway request/action if enabled | Required |

## VOS / Product Basis

VOS mapping/online mapping gateway metrics are documented. [VOS]/[HYBRID]
...
- `page_viewed` with page=`my-gateways` and side=`client`.
