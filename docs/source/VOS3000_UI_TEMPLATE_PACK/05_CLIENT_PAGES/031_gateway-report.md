...
Customer gateway performance report.
...
|---|---|---|
| F01 | Gateway | Required |
| F02 | calls | Required |
| F03 | minutes | Required |
| F04 | ASR | Required |
| F05 | ACD | Required |
| F06 | PDD | Required |
| F07 | failure rate | Required |
| F08 | network delay/loss if available | Required |
| F09 | export | Required |

## VOS / Product Basis

VOS has gateway reports/performance; customer projection is [HYBRID].
...
- `page_viewed` with page=`gateway-report` and side=`client`.
