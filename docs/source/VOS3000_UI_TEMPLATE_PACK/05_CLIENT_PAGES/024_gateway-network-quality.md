...
Network health for the customer's gateway.
...
|---|---|---|
| F01 | Remote IP | Required |
| F02 | current network quality | Required |
| F03 | packet loss | Required |
| F04 | network delay | Required |
| F05 | 24h/7d historical portal chart | Required |
| F06 | degraded thresholds | Required |
| F07 | support ticket shortcut | Required |

## VOS / Product Basis

VOS Mapping Gateway Network documents remote IP, network quality, packet loss and delay. History is [HYBRID].
...
**Left**
- Page title: **Gateway Network Quality**
...
- `page_viewed` with page=`gateway-network-quality` and side=`client`.
