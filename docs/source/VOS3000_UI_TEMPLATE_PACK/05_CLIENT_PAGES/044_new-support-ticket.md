...
Create context-rich support request.
...
|---|---|---|
| F01 | Subject | Required |
| F02 | category | Required |
| F03 | description | Required |
| F04 | optional gateway | Required |
| F05 | optional CDR/call ID | Required |
| F06 | attachment | Required |
| F07 | auto-attach safe diagnostics after user consent | Required |
| F08 | confirmation/reference | Required |
...
- `page_viewed` with page=`new-support-ticket` and side=`client`.
