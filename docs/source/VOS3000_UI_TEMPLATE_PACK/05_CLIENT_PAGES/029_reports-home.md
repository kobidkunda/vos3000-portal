...
|---|---|---|
| F01 | Traffic summary | Required |
| F02 | billing/usage | Required |
| F03 | destination | Required |
| F04 | gateway quality | Required |
| F05 | failure summary | Required |
| F06 | saved reports | Required |
| F07 | recent exports | Required |
...
- `page_viewed` with page=`reports-home` and side=`client`.
