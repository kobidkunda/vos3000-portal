...
|---|---|---|
| F01 | My gateways | Required |
| F02 | online/offline/degraded | Required |
| F03 | registered IP | Required |
| F04 | last update | Required |
| F05 | network quality | Required |
| F06 | packet loss | Required |
| F07 | latency | Required |
| F08 | active incidents affecting this customer | Required |
| F09 | refresh timestamp | Required |

## VOS / Product Basis

Uses documented VOS gateway online/network data plus portal incident context. [HYBRID]
...
- `page_viewed` with page=`service-status` and side=`client`.
