...
Customer-facing call failure intelligence.
...
|---|---|---|
| F01 | Top termination reasons | Required |
| F02 | failure-rate trend | Required |
| F03 | failure by destination | Required |
| F04 | failure by customer gateway | Required |
| F05 | human-readable explanation | Required |
| F06 | drill to affected CDRs | Required |
| F07 | do not expose other carrier/customer details | Required |

## VOS / Product Basis

VOS CDR termination reason and gateway outcome data support this. [HYBRID]
...
- `page_viewed` with page=`failure-analytics` and side=`client`.
