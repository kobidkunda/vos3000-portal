...
Customer entry point for programmatic access.
...
|---|---|---|
| F01 | Base URL | Required |
| F02 | authentication model | Required |
| F03 | scopes summary | Required |
| F04 | rate limits | Required |
| F05 | quick-start snippets | Required |
| F06 | links to CDR/balance/gateway/rates endpoints | Required |
| F07 | sandbox/test notes if provided | Required |
...
- `page_viewed` with page=`api-overview` and side=`client`.
