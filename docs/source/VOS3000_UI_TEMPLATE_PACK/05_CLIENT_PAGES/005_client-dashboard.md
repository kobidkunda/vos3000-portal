...
At-a-glance balance, traffic and service status.
...
|---|---|---|
| F01 | Balance | Required |
| F02 | credit/overdraft if customer is allowed to see it | Required |
| F03 | today spend | Required |
| F04 | month-to-date spend | Required |
| F05 | active calls | Required |
| F06 | channel usage | Required |
| F07 | current CPS vs limit | Required |
| F08 | ASR | Required |
| F09 | ACD | Required |
| F10 | PDD | Required |
| F11 | gateway online/offline count | Required |
| F12 | recent payment | Required |
| F13 | 24h calls/minutes/spend charts | Required |
| F14 | low balance/expiry/gateway issue banners | Required |
| F15 | quick links: Add Funds, Live Calls, CDR, Gateways, Rate Lookup | Required |

## VOS / Product Basis

VOS documents account balance/today consumption, current calls and online gateway metrics. Dashboard composition is [HYBRID].
...
- `page_viewed` with page=`client-dashboard` and side=`client`.
