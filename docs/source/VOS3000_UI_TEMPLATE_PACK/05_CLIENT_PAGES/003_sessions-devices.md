...
|---|---|---|
| F01 | Current device | Required |
| F02 | other sessions with IP/browser/time | Required |
| F03 | revoke individual | Required |
| F04 | revoke all others | Required |
| F05 | security notification on new login | Required |
...
- `page_viewed` with page=`sessions-devices` and side=`client`.
