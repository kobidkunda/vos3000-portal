...
Single catalog for all operational, billing and analysis reports.
...
|---|---|---|
| F01 | Categories: billing, cards, clearing, analysis, finance, quality, customer | Required |
| F02 | Saved report presets | Required |
| F03 | Run now | Required |
| F04 | Async export | Required |
| F05 | Schedule report | Required |
| F06 | Share to approved recipient | Required |
| F07 | Report history | Required |

## VOS / Product Basis

VOS includes Data Report and Report Management; scheduling UX is [HYBRID].
...
- `page_viewed` with page=`report-center` and side=`admin`.
