...
Deep single-call inspection and safe operator actions.
...
|---|---|---|
| F01 | All live-call fields | Required |
| F02 | Leg-by-leg topology | Required |
| F03 | Customer and carrier account links | Required |
| F04 | Media/codec panel | Required |
| F05 | Call analysis link | Required |
| F06 | Audio-traffic/voice-sample actions only for highly privileged roles | Required |
| F07 | Disconnect-call button with confirmation and mandatory reason | Required |
| F08 | Audit dangerous actions | Required |

## VOS / Product Basis

VOS Current Call includes disconnect, audio traffic, voice samples and call analysis actions. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`live-call-detail` and side=`admin`.
