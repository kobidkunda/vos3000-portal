...
|---|---|
| Side | **Admin** |
| Product group | **Gateways & Routing** |
...
Single live view of all online routing and mapping gateways.
...
|---|---|---|
| F01 | Tabs mapping/routing | Required |
| F02 | Current sessions vs capacity | Required |
| F03 | ASR | Required |
| F04 | ACD | Required |
| F05 | CPS | Required |
| F06 | registered IP | Required |
| F07 | registration time | Required |
| F08 | last update | Required |
| F09 | online duration | Required |
| F10 | encryption | Required |
| F11 | softswitch | Required |
| F12 | open current calls | Required |

## VOS / Product Basis

Directly maps documented Online Routing/Mapping Gateway fields. [VOS]
...
- `page_viewed` with page=`online-gateways` and side=`admin`.
