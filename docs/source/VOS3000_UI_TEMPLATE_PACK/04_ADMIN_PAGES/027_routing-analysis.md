...
Simulate route selection before changing production.
...
|---|---|---|
| F01 | Authentication method: existing device or static IP | Required |
| F02 | Device type and ID | Required |
| F03 | Caller | Required |
| F04 | Callee | Required |
| F05 | Softswitch | Required |
| F06 | Output actual caller device/account | Required |
| F07 | Routing caller/callee after rewrite | Required |
| F08 | Customer rate/minute | Required |
| F09 | Available time | Required |
| F10 | Candidate routes with egress rate | Required |
| F11 | Rate deviation/margin | Required |
| F12 | Route detail and sequence | Required |

## VOS / Product Basis

VOS Routing Analysis documents these inputs/outputs. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`routing-analysis` and side=`admin`.
