...
Visualize and manage agent hierarchies.
...
|---|---|---|
| F01 | Tree and table view | Required |
| F02 | Direct vs all descendants | Required |
| F03 | Parent agent | Required |
| F04 | Balances and status per node | Required |
| F05 | Create child account | Required |
| F06 | Move/reparent only if safe and supported | Required |
| F07 | Permission inheritance preview | Required |
| F08 | Aggregate spend/traffic | Required |

## VOS / Product Basis

VOS documents Agent Account and direct/all subaccount views. [VOS]/[HYBRID]
...
**Left**
- Page title: **Agent & Subaccount Tree**
...
- `page_viewed` with page=`agent-subaccount-tree` and side=`admin`.
