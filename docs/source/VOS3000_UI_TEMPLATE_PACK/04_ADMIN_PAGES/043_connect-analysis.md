...
Expose VOS CDR analysis for connection behavior.
...
|---|---|---|
| F01 | Time filter | Required |
| F02 | Customer/gateway/destination filter | Required |
| F03 | ASR/connection KPIs | Required |
| F04 | Trend/chart | Required |
| F05 | Drill to source CDR | Required |

## VOS / Product Basis

VOS has CDR Analysis > Connect Analysis. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`connect-analysis` and side=`admin`.
