...
|---|---|---|
| F01 | Serial number search | Required |
| F02 | Caller signaling | Required |
| F03 | Callee signaling | Required |
| F04 | Softswitch memo | Required |
| F05 | Timestamp sequence | Required |
| F06 | Export signaling | Required |
| F07 | Import signaling file only if needed | Required |
| F08 | Link from CDR/live call | Required |

## VOS / Product Basis

VOS Call Analysis is documented. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`call-analysis` and side=`admin`.
