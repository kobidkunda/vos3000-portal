...
Manage reusable customer/carrier rate groups.
...
|---|---|---|
| F01 | Group name | Required |
| F02 | Number of rates | Required |
| F03 | Number of using accounts | Required |
| F04 | memo | Required |
| F05 | creator | Required |
| F06 | authorization visibility | Required |
| F07 | create/duplicate/archive | Required |
| F08 | open rates | Required |

## VOS / Product Basis

VOS Rate Group Management documents these concepts. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`rate-groups` and side=`admin`.
