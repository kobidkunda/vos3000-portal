...
Query and organize allowed number ranges/prefixes.
...
|---|---|---|
| F01 | Search prefix/range | Required |
| F02 | customer/agent ownership context | Required |
| F03 | export | Required |
| F04 | link to account limits | Required |

## VOS / Product Basis

VOS Number Section Query exists. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`number-sections` and side=`admin`.
