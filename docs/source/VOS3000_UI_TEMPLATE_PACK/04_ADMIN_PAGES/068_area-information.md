...
Map prefixes to human-readable destinations.
...
|---|---|---|
| F01 | Area prefix | Required |
| F02 | area name | Required |
| F03 | memo | Required |
| F04 | longest-match behavior note | Required |
| F05 | import/export wrapper | Required |

## VOS / Product Basis

VOS Area Information is used for rate display/matching. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`area-information` and side=`admin`.
