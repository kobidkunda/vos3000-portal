...
Assign and inspect package subscriptions.
...
|---|---|---|
| F01 | Package name | Required |
| F02 | Effective date | Required |
| F03 | Invalid time | Required |
| F04 | Priority | Required |
| F05 | Failed-processing mode | Required |
| F06 | Percentage rent | Required |
| F07 | Package period/rent/minimum consumption/free duration/free amount summary | Required |
| F08 | Add/remove package | Required |
| F09 | Future package schedule | Required |

## VOS / Product Basis

VOS Customer Package Management documents effective/invalid dates, priority and failed processing. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`customer-packages` and side=`admin`.
