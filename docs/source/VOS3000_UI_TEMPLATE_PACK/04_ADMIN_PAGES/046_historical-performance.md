...
Longitudinal quality and traffic trend.
...
|---|---|---|
| F01 | ASR/ACD/minutes/calls over time | Required |
| F02 | Compare periods | Required |
| F03 | Customer/gateway filter | Required |
| F04 | Export | Required |

## VOS / Product Basis

VOS has Historical Performance. [VOS]/[HYBRID]
...
**Left**
- Page title: **Historical Performance**
...
- `page_viewed` with page=`historical-performance` and side=`admin`.
