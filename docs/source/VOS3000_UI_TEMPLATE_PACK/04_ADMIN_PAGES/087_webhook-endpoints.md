...
Manage outbound event delivery.
...
|---|---|---|
| F01 | Customer/integration | Required |
| F02 | URL | Required |
| F03 | events | Required |
| F04 | signing secret | Required |
| F05 | enabled state | Required |
| F06 | created/last success | Required |
| F07 | failure count | Required |
| F08 | test event | Required |
| F09 | rotate secret | Required |
...
- `page_viewed` with page=`webhook-endpoints` and side=`admin`.
