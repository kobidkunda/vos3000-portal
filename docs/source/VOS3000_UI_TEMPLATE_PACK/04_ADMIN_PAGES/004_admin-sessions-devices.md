...
Review and terminate active admin sessions.
...
|---|---|---|
| F01 | Current session highlight | Required |
| F02 | IP, browser, approximate location, created/last-active time | Required |
| F03 | Revoke one session | Required |
| F04 | Revoke all other sessions | Required |
| F05 | Suspicious-session marker | Required |
...
**Left**
- Page title: **Admin Sessions & Devices**
...
- `page_viewed` with page=`admin-sessions-devices` and side=`admin`.
