...
Secure password recovery without exposing VOS credentials.
...
|---|---|---|
| F01 | Email-based reset | Required |
| F02 | Single-use expiring token | Required |
| F03 | Password policy | Required |
| F04 | Invalidate active sessions after reset | Required |
| F05 | Audit event | Required |
...
**Left**
- Page title: **Forgot / Reset Password**
...
- `page_viewed` with page=`forgot-reset-password` and side=`admin`.
