...
Inspect VOS web-service access equipment.
...
|---|---|---|
| F01 | Access name | Required |
| F02 | mark | Required |
| F03 | additional setting | Required |
| F04 | creation time | Required |
| F05 | access time | Required |
| F06 | access IP | Required |
| F07 | memo | Required |

## VOS / Product Basis

VOS Interface Management > Web Service Equipment documents these fields. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **VOS Web Service Equipment**
...
- `page_viewed` with page=`vos-web-service-equipment` and side=`admin`.
