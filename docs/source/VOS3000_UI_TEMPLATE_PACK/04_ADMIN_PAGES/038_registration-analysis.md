...
Analyze registration signaling problems.
...
|---|---|---|
| F01 | Serial number | Required |
| F02 | Registration signaling | Required |
| F03 | Softswitch memo | Required |
| F04 | Time | Required |
| F05 | Filter/export | Required |
| F06 | Link to phone/gateway | Required |

## VOS / Product Basis

VOS Registration Analysis is documented. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Registration Analysis**
...
- `page_viewed` with page=`registration-analysis` and side=`admin`.
