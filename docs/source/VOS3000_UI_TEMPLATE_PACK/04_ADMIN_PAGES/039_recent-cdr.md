...
Fast access to most recent records.
...
|---|---|---|
| F01 | Last 1,000 by default according to VOS behavior | Required |
| F02 | Caller/callee | Required |
| F03 | begin/end | Required |
| F04 | duration/charged duration | Required |
| F05 | charges/expense | Required |
| F06 | termination reason | Required |
| F07 | gateway/account/IP | Required |
| F08 | quick customer and call detail links | Required |

## VOS / Product Basis

VOS Recent CDR explicitly returns recent records and references CDR fields. [VOS]
...
- `page_viewed` with page=`recent-cdr` and side=`admin`.
