...
Manage registrations to other SIP/H323 platforms.
...
|---|---|---|
| F01 | Mark/identifier | Required |
| F02 | Username | Required |
| F03 | Masked authentication password | Required |
| F04 | Server IP | Required |
| F05 | Line limit | Required |
| F06 | Signaling port | Required |
| F07 | Encryption | Required |
| F08 | Host name | Required |
| F09 | SIP proxy | Required |
| F10 | User-Agent | Required |
| F11 | Local IP/port | Required |
| F12 | Test/trace link | Required |

## VOS / Product Basis

Fields are documented in VOS Registration Management. Writes [VERIFY-API].
...
- `page_viewed` with page=`registration-management` and side=`admin`.
