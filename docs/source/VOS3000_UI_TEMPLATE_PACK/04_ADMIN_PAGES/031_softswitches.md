...
View/manage softswitch instances and their operational settings.
...
|---|---|---|
| F01 | Softswitch list/status | Required |
| F02 | Assigned gateways | Required |
| F03 | Current load | Required |
| F04 | IP | Required |
| F05 | Configuration entry point | Required |
| F06 | Link to system parameters and monitors | Required |

## VOS / Product Basis

VOS documents Softswitch Management. [VERIFY-API]
...
- `page_viewed` with page=`softswitches` and side=`admin`.
