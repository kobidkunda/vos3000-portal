...
Aggregated gateway call outcomes.
...
| F02 | Total calls | Required |
| F03 | Success | Required |
| F04 | Callee rejected | Required |
| F05 | Trunk error | Required |
| F06 | Network error | Required |
| F07 | Caller abandon | Required |
| F08 | Average talk duration | Required |
| F09 | Total call time | Required |
| F10 | IP | Required |
| F11 | Starting time | Required |
| F12 | Success/failure percentages | Required |

## VOS / Product Basis

VOS Gateway Status fields are documented. [VOS]
...
**Left**
- Page title: **Gateway Status Analytics**
...
- `page_viewed` with page=`gateway-status-analytics` and side=`admin`.
