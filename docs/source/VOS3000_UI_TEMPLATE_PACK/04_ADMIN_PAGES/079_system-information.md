...
Display connected VOS server information.
...
|---|---|---|
| F01 | Server/version/environment | Required |
| F02 | connected adapter | Required |
| F03 | time/timezone | Required |
| F04 | softswitch summary | Required |
| F05 | license/expiry only if available | Required |
| F06 | copy diagnostic bundle | Required |

## VOS / Product Basis

VOS System Information exists. Exact fields [VERIFY-API].
...
- `page_viewed` with page=`system-information` and side=`admin`.
