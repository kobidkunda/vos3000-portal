...
Review and manage dynamically blocked numbers.
...
| F02 | type malicious/no-answer | Required |
| F03 | effective date | Required |
| F04 | expiration | Required |
| F05 | last call time | Required |
| F06 | softswitch | Required |
| F07 | manual add/remove/expire subject to VOS support | Required |

## VOS / Product Basis

VOS Dynamic Black List fields are documented. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`dynamic-black-list` and side=`admin`.
