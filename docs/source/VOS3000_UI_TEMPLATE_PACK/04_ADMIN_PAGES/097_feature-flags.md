...
Gradually enable portal modules by tenant.
...
|---|---|---|
| F01 | Feature name | Required |
| F02 | global state | Required |
| F03 | customer overrides | Required |
| F04 | dependency checks | Required |
| F05 | audit every change | Required |
...
- `page_viewed` with page=`feature-flags` and side=`admin`.
