...
Manage caller/callee full-match list groups.
...
| F02 | memo | Required |
| F03 | member numbers | Required |
| F04 | search/import/export | Required |
| F05 | usage references to gateways/phones | Required |
| F06 | bulk add/remove | Required |

## VOS / Product Basis

VOS Black/White List Group is documented as full-match and usable by gateways/phones. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Black / White List Groups**
...
- `page_viewed` with page=`black-white-list-groups` and side=`admin`.
