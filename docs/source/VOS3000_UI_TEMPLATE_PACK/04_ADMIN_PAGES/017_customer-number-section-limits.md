...
Limit number ranges that a customer/agent may allocate.
...
|---|---|---|
| F01 | Begin number | Required |
| F02 | End number | Required |
| F03 | Validation for overlap | Required |
| F04 | Agent inheritance display | Required |
| F05 | Add/remove range | Required |
| F06 | Audit changes | Required |

## VOS / Product Basis

VOS Number Section Limitation is documented. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Customer Number Section Limits**
...
- `page_viewed` with page=`customer-number-section-limits` and side=`admin`.
