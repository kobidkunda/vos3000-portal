...
|---|---|---|
| F01 | Time/destination/customer/gateway filters | Required |
| F02 | Interrupt distribution | Required |
| F03 | Reason and duration buckets | Required |
| F04 | Drill to CDR | Required |

## VOS / Product Basis

VOS has Interrupt Analysis. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`interrupt-analysis` and side=`admin`.
