...
Portfolio-level balance reporting.
...
|---|---|---|
| F01 | Customer/account | Required |
| F02 | current balance | Required |
| F03 | credit/overdraft | Required |
| F04 | status | Required |
| F05 | low-balance threshold | Required |
| F06 | agent hierarchy | Required |
| F07 | export | Required |

## VOS / Product Basis

VOS Account Balance query/report exists. [VOS]/[HYBRID]
...
**Left**
- Page title: **Account Balance Report**
...
- `page_viewed` with page=`account-balance-report` and side=`admin`.
