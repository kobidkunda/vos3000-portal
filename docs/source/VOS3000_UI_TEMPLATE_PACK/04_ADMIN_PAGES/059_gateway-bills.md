...
Consumption/billing by mapping gateway.
...
| F02 | IP | Required |
| F03 | account | Required |
| F04 | period | Required |
| F05 | calls/minutes/charges | Required |
| F06 | export | Required |
| F07 | drill to CDR | Required |

## VOS / Product Basis

VOS Gateway Bill is documented. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`gateway-bills` and side=`admin`.
