...
Delivery audit for all notifications.
...
|---|---|---|
| F01 | Recipient | Required |
| F02 | event | Required |
| F03 | channel | Required |
| F04 | status | Required |
| F05 | attempts | Required |
| F06 | provider ID | Required |
| F07 | timestamp | Required |
| F08 | retry | Required |
...
- `page_viewed` with page=`notification-log` and side=`admin`.
