...
|---|---|
| Side | **Admin** |
| Product group | **Live Calls & Diagnostics** |
...
| F02 | Mapping/routing gateway | Required |
| F03 | Connect time | Required |
| F04 | Duration | Required |
| F05 | Connecting duration | Required |
| F06 | PDD | Required |
| F07 | Codec | Required |
| F08 | Packet/traffic indicators | Required |
| F09 | Caller/callee IP and RTP IP | Required |
| F10 | DTMF mode | Required |
| F11 | Media routing | Required |
| F12 | Device names | Required |
| F13 | Encryption | Required |
| F14 | Softswitch | Required |
| F15 | Filters by customer/gateway/caller/callee/duration | Required |
| F16 | WebSocket/SSE updates | Required |

## VOS / Product Basis

Current Call fields are explicitly documented by VOS. [VOS]/[HYBRID]
...
- `page_viewed` with page=`live-calls` and side=`admin`.
...
- [ ] All source requirements F01..F16 implemented or explicitly deferred with approval.
