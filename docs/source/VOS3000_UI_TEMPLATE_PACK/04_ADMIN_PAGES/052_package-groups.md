...
| F02 | rent period/unit | Required |
| F03 | rent fee | Required |
| F04 | minimum consumption | Required |
| F05 | effective-spending limit | Required |
| F06 | period rates | Required |
| F07 | free duration | Required |
| F08 | free money | Required |
| F09 | using accounts | Required |
| F10 | authorization | Required |

## VOS / Product Basis

VOS Package Management documents these fields. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`package-groups` and side=`admin`.
