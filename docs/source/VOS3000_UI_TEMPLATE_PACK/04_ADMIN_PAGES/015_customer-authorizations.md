...
Manage delegated account/gateway/phone/payment privileges.
...
|---|---|---|
| F01 | Add/delete/modify account permission | Required |
| F02 | Add/delete/modify phone permission | Required |
| F03 | Phone-card permission | Required |
| F04 | Add/delete gateway permission | Required |
| F05 | Modify gateway information | Required |
| F06 | Modify gateway capacity | Required |
| F07 | Payment for this account | Required |
| F08 | Payment for subaccounts | Required |
| F09 | Number-section limitation | Required |
| F10 | Inherited/explicit permission visualization | Required |

## VOS / Product Basis

VOS explicitly documents these authorization categories and subaccount restrictions. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Customer Authorizations**
...
- `page_viewed` with page=`customer-authorizations` and side=`admin`.
