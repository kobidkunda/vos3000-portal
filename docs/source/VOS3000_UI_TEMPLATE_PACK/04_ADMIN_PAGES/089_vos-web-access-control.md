...
|---|---|
| Side | **Admin** |
| Product group | **API, Integrations & Automation** |
...
View/configure VOS external access controls.
...
|---|---|---|
| F01 | Web service equipment | Required |
| F02 | directory name | Required |
| F03 | allowed IP | Required |
| F04 | memo | Required |
| F05 | change audit | Required |
| F06 | very restricted permission | Required |

## VOS / Product Basis

VOS Interface Management > Web Access Control documents these fields. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **VOS Web Access Control**
...
- `page_viewed` with page=`vos-web-access-control` and side=`admin`.
