...
Detect unprofitable customer/carrier combinations.
...
|---|---|---|
| F01 | Customer rate vs carrier cost | Required |
| F02 | Margin/minute | Required |
| F03 | Estimated daily margin | Required |
| F04 | Negative-margin destinations | Required |
| F05 | Gateway/customer drilldowns | Required |
| F06 | Threshold alarm | Required |

## VOS / Product Basis

VOS Routing Analysis exposes customer rate, egress rate and rate deviation; consolidated monitoring is [HYBRID].
...
- `page_viewed` with page=`margin-monitor` and side=`admin`.
