...
Manage disallowed media/RTP addresses.
...
|---|---|---|
| F01 | IP/CIDR | Required |
| F02 | Reason | Required |
| F03 | Created by/time | Required |
| F04 | Enabled state | Required |
| F05 | Search/filter | Required |
| F06 | Add/remove | Required |

## VOS / Product Basis

VOS includes Prohibited Media IP management. [VERIFY-API]
...
**Left**
- Page title: **Prohibited Media IP**
...
- `page_viewed` with page=`prohibited-media-ip` and side=`admin`.
