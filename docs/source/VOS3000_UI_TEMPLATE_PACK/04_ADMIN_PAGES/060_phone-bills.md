...
| F03 | period | Required |
| F04 | usage/charges | Required |
| F05 | export | Required |
| F06 | drill to CDR | Required |

## VOS / Product Basis

VOS Phone Bill exists. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`phone-bills` and side=`admin`.
