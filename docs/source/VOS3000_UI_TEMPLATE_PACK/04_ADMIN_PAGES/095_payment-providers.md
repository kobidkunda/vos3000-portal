...
|---|---|
| Side | **Admin** |
| Product group | **Portal Operations** |
...
Configure customer top-up providers.
...
|---|---|---|
| F01 | Provider enabled state | Required |
| F02 | currency support | Required |
| F03 | minimum/maximum deposit | Required |
| F04 | fee handling | Required |
| F05 | webhook secret health | Required |
| F06 | test mode indicator | Required |
| F07 | never display raw secrets after save | Required |
...
- `page_viewed` with page=`payment-providers` and side=`admin`.
