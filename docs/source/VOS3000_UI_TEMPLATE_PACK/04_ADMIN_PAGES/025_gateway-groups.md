...
Organize gateways for shared capacity and routing policy.
...
| F02 | Type | Required |
| F03 | Member gateways | Required |
| F04 | Capacity summary | Required |
| F05 | Active calls | Required |
| F06 | Policy/notes | Required |
| F07 | Add/remove members | Required |
| F08 | Impact preview | Required |

## VOS / Product Basis

VOS documents Gateway Group. Exact API [VERIFY-API].
...
- `page_viewed` with page=`gateway-groups` and side=`admin`.
