...
|---|---|---|
| F01 | Server list | Required |
| F02 | role | Required |
| F03 | status | Required |
| F04 | health indicators | Required |
| F05 | last update | Required |
| F06 | drill to alarms/performance | Required |

## VOS / Product Basis

VOS Server Monitor exists. [VERIFY-API]
...
- `page_viewed` with page=`server-monitor` and side=`admin`.
