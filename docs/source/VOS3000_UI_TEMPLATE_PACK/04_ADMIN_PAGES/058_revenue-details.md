...
|---|---|---|
| F01 | Time period | Required |
| F02 | account/customer | Required |
| F03 | call types | Required |
| F04 | call charges | Required |
| F05 | package amounts | Required |
| F06 | minutes | Required |
| F07 | CDR counts | Required |
| F08 | export | Required |

## VOS / Product Basis

VOS Bill Query includes Revenue Details. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`revenue-details` and side=`admin`.
