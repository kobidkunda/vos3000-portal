...
Manage system-level allowed phone numbers.
...
| F02 | memo | Required |
| F03 | add/remove | Required |
| F04 | search/export | Required |

## VOS / Product Basis

VOS System White List is documented. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`system-white-list` and side=`admin`.
