...
Live registration and capacity view.
...
|---|---|---|
| F01 | Phone number | Required |
| F02 | Current calls | Required |
| F03 | Line limit | Required |
| F04 | In/out capacity and limits | Required |
| F05 | Device model | Required |
| F06 | Protocol | Required |
| F07 | Registered IP | Required |
| F08 | Registration/update time | Required |
| F09 | Duration | Required |
| F10 | Encryption | Required |
| F11 | Tracing state | Required |
| F12 | Softswitch | Required |

## VOS / Product Basis

VOS Online Phone fields are documented. [VOS]
...
- `page_viewed` with page=`online-phones` and side=`admin`.
