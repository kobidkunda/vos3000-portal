...
Manage carrier-side egress gateways.
...
|---|---|---|
| F01 | Carrier/customer association | Required |
| F02 | Gateway prefix | Required |
| F03 | IP/registration | Required |
| F04 | Line limit | Required |
| F05 | Current calls | Required |
| F06 | ASR/ACD | Required |
| F07 | CPS | Required |
| F08 | rate/cost indicator | Required |
| F09 | route/protect-route status | Required |
| F10 | softswitch | Required |
| F11 | online status | Required |
| F12 | bulk actions | Required |

## VOS / Product Basis

Routing Gateway and Online Routing Gateway are documented. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`routing-gateways` and side=`admin`.
