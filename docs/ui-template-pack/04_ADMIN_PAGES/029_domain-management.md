...
Manage domains used by the VOS environment.
...
|---|---|---|
| F01 | Domain list | Required |
| F02 | Resolution/status | Required |
| F03 | Associated gateway/service | Required |
| F04 | Last update | Required |
| F05 | Add/edit/delete subject to supported interface | Required |

## VOS / Product Basis

VOS has Domain Management. Field-level API requires verification. [VERIFY-API]
...
- `page_viewed` with page=`domain-management` and side=`admin`.
