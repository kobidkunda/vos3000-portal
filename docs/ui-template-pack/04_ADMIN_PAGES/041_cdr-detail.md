...
Human-readable single-call record.
...
|---|---|---|
| F01 | Timeline: begin → routing → connect → end | Required |
| F02 | Caller/callee original and outbound rewritten values | Required |
| F03 | Actual vs charged duration | Required |
| F04 | Customer charge/tax | Required |
| F05 | Carrier expense/tax | Required |
| F06 | Gross margin | Required |
| F07 | Account/agent | Required |
| F08 | Mapping/routing gateway | Required |
| F09 | Caller/callee IP | Required |
| F10 | Call type/area | Required |
| F11 | Termination reason/hangup side | Required |
| F12 | Billing method/mode | Required |
| F13 | PDD/continue/connect delay | Required |
| F14 | Calling/called Call-ID | Required |
| F15 | Serial | Required |
| F16 | Open call analysis | Required |

## VOS / Product Basis

Fields map directly to VOS CDR. Margin display is [HYBRID].
...
- `page_viewed` with page=`cdr-detail` and side=`admin`.
