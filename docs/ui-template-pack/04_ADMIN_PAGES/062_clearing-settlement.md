...
Carrier/customer settlement workspace.
...
|---|---|---|
| F01 | Clearing account detail | Required |
| F02 | gateway details | Required |
| F03 | clearing balance | Required |
| F04 | settlement period | Required |
| F05 | reconciliation flags | Required |
| F06 | export | Required |
| F07 | summary | Required |

## VOS / Product Basis

VOS documents clearing queries/reports and summary of financial settlement. [VOS]/[HYBRID]
...
**Left**
- Page title: **Clearing & Settlement**
...
- `page_viewed` with page=`clearing-settlement` and side=`admin`.
