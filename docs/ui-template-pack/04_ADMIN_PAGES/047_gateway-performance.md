...
Compare gateway quality and utilization.
...
| F05 | failure rate | Required |
| F06 | cost/margin overlay | Required |
| F07 | capacity utilization | Required |
| F08 | ranking | Required |

## VOS / Product Basis

VOS has Gateway Performance; business overlays are [HYBRID].
...
**Left**
- Page title: **Gateway Performance**
...
- `page_viewed` with page=`gateway-performance` and side=`admin`.
