...
|---|---|
| Side | **Admin** |
| Product group | **Admin Users, Roles & Audit** |
...
Fine-grained RBAC independent of the VOS client.
...
|---|---|---|
| F01 | Role templates: Super Admin, NOC, Billing, Support, Sales, Read Only | Required |
| F02 | Resource/action matrix | Required |
| F03 | View/edit distinction | Required |
| F04 | Dangerous actions separated: disconnect call, payment adjustment, rate apply, gateway delete, system parameter write | Required |
| F05 | Customer-scope constraints | Required |
| F06 | Permission diff/preview | Required |
| F07 | Clone role | Required |

## VOS / Product Basis

VOS documents navigation preview, detailed view/edit privilege and operation authorization. Portal RBAC mirrors the principle. [HYBRID]
...
- `page_viewed` with page=`roles-permissions` and side=`admin`.
