...
|---|---|
| Side | **Admin** |
| Product group | **System & Maintenance** |
...
Search and edit allowed VOS system parameters.
...
|---|---|---|
| F01 | Parameter name/value/description | Required |
| F02 | Search by key | Required |
| F03 | Read-only by default | Required |
| F04 | Allowlisted editable parameters | Required |
| F05 | Validation by datatype/range | Required |
| F06 | Before/after diff | Required |
| F07 | Change ticket/reason | Required |
| F08 | Two-person approval for high-risk settings | Required |
| F09 | Rollback note | Required |

## VOS / Product Basis

VOS System Parameter exposes name/value/description. Writes are sensitive and [VERIFY-API].
...
- `page_viewed` with page=`system-parameters` and side=`admin`.
