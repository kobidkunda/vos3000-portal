...
| F02 | area prefix | Required |
| F03 | free duration | Required |
| F04 | billing cycle | Required |
| F05 | memo | Required |
| F06 | usage preview | Required |

## VOS / Product Basis

VOS Package Free Duration Management is documented. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Package Free Duration**
...
- `page_viewed` with page=`package-free-duration` and side=`admin`.
