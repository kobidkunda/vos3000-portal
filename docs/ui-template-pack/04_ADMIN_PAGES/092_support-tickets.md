...
Internal support queue connected to customer/call context.
...
|---|---|---|
| F01 | Statuses, priority, category, assignee, SLA | Required |
| F02 | Link customer/gateway/CDR/call | Required |
| F03 | Internal notes vs customer replies | Required |
| F04 | attachments | Required |
| F05 | merge/close/reopen | Required |
| F06 | saved queues | Required |
...
- `page_viewed` with page=`support-tickets` and side=`admin`.
