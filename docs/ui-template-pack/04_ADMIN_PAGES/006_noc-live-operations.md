...
Real-time wallboard for network operations.
...
|---|---|---|
| F01 | Live concurrency | Required |
| F02 | Current CPS | Required |
| F03 | Answered/failed call ratio | Required |
| F04 | ASR/ACD/PDD | Required |
| F05 | Gateway online/offline/degraded tiles | Required |
| F06 | Packet loss and network delay | Required |
| F07 | Top SIP/termination failures | Required |
| F08 | Alarm stream | Required |
| F09 | Auto-refresh/WebSocket connection status | Required |
| F10 | Fullscreen NOC mode | Required |

## VOS / Product Basis

Online gateway, gateway-network and Current Call data are documented by VOS. [HYBRID]
...
**Left**
- Page title: **NOC Live Operations**
...
- `page_viewed` with page=`noc-live-operations` and side=`admin`.
