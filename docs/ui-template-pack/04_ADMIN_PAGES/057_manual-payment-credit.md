...
Controlled operator-initiated financial adjustment.
...
|---|---|---|
| F01 | Customer/account lookup | Required |
| F02 | Action: payment/credit/make-zero subject to role | Required |
| F03 | Amount | Required |
| F04 | Currency | Required |
| F05 | memo required | Required |
| F06 | Before/after balance | Required |
| F07 | Approval if threshold exceeded | Required |
| F08 | Idempotency key | Required |
| F09 | Result and serial/reference | Required |

## VOS / Product Basis

VOS supports Payment/Credit/Make Zero. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Manual Payment / Credit**
...
- `page_viewed` with page=`manual-payment-credit` and side=`admin`.
