...
|---|---|
| Side | **Admin** |
| Product group | **Rates, Packages & Commercial Routing** |
...
Search, import, edit and validate rate prefixes.
...
|---|---|---|
| F01 | Rate prefix | Required |
| F02 | area prefix/name | Required |
| F03 | rate type | Required |
| F04 | billing rate | Required |
| F05 | billing cycle | Required |
| F06 | rate/minute | Required |
| F07 | lock | Required |
| F08 | section rates | Required |
| F09 | tax | Required |
| F10 | bulk import/export | Required |
| F11 | prefix collision validation | Required |
| F12 | effective/future-change wrapper in portal | Required |
| F13 | impact count of attached accounts | Required |

## VOS / Product Basis

VOS documents longest-prefix matching, rate type, billing rate/cycle and import/export. Future workflow is [HYBRID].
...
- `page_viewed` with page=`rate-editor` and side=`admin`.
...
- [ ] All source requirements F01..F13 implemented or explicitly deferred with approval.
