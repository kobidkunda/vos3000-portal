...
Portal-managed report delivery.
...
|---|---|---|
| F01 | Report template | Required |
| F02 | filters | Required |
| F03 | frequency | Required |
| F04 | timezone | Required |
| F05 | recipients | Required |
| F06 | format | Required |
| F07 | last/next run | Required |
| F08 | failure status | Required |
| F09 | pause/resume | Required |
...
- `page_viewed` with page=`scheduled-reports` and side=`admin`.
