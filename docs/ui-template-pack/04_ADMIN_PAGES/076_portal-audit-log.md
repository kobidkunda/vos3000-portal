...
Immutable audit trail of all portal mutations.
...
| F01 | Actor | Required |
| F02 | role | Required |
| F03 | customer scope | Required |
| F04 | IP/session | Required |
| F05 | action | Required |
| F06 | resource | Required |
| F07 | before/after values | Required |
| F08 | request ID | Required |
| F09 | result | Required |
| F10 | timestamp | Required |
| F11 | filter/export | Required |
| F12 | retention policy | Required |
...
- `page_viewed` with page=`portal-audit-log` and side=`admin`.
