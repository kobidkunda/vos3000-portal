...
Safe large-rate-sheet ingestion.
...
|---|---|---|
| F01 | Upload CSV/XLSX | Required |
| F02 | Map columns | Required |
| F03 | Normalize prefixes | Required |
| F04 | Preview add/change/delete counts | Required |
| F05 | Validation errors | Required |
| F06 | Duplicate/overlap warnings | Required |
| F07 | Dry run | Required |
| F08 | Approval workflow | Required |
| F09 | Apply job | Required |
| F10 | Rollback snapshot maintained by portal | Required |

## VOS / Product Basis

Built around VOS import/export capability. [HYBRID]/[VERIFY-API]
...
- `page_viewed` with page=`rate-import-jobs` and side=`admin`.
