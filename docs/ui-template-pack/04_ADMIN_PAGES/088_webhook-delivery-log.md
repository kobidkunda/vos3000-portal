...
|---|---|---|
| F01 | Event ID/type | Required |
| F02 | customer | Required |
| F03 | endpoint | Required |
| F04 | attempt | Required |
| F05 | HTTP status | Required |
| F06 | latency | Required |
| F07 | response excerpt | Required |
| F08 | next retry | Required |
| F09 | manual retry | Required |
| F10 | payload viewer with secrets redacted | Required |
...
- `page_viewed` with page=`webhook-delivery-log` and side=`admin`.
