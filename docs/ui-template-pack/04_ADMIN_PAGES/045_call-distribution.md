...
|---|---|---|
| F01 | By hour | Required |
| F02 | destination | Required |
| F03 | account | Required |
| F04 | gateway | Required |
| F05 | duration band | Required |
| F06 | call type | Required |
| F07 | heatmaps and tables | Required |

## VOS / Product Basis

VOS has Call Distribution analysis. [VOS]/[HYBRID]
...
- `page_viewed` with page=`call-distribution` and side=`admin`.
