...
| F02 | gateway offline/online | Required |
| F03 | ASR drop | Required |
| F04 | high failure | Required |
| F05 | packet loss/latency | Required |
| F06 | payment result | Required |
| F07 | rate change | Required |
| F08 | account expiry | Required |
| F09 | threshold, duration and cool-down | Required |
| F10 | channels email/webhook/others | Required |
| F11 | customer opt-in rules | Required |
...
**Left**
- Page title: **Notification Policies**
...
- `page_viewed` with page=`notification-policies` and side=`admin`.
