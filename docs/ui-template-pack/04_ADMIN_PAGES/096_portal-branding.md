...
|---|---|---|
| F01 | Logo | Required |
| F02 | favicon | Required |
| F03 | product name | Required |
| F04 | support contact | Required |
| F05 | legal links | Required |
| F06 | timezone/currency defaults | Required |
| F07 | email sender identity | Required |
| F08 | preview | Required |
...
- `page_viewed` with page=`portal-branding` and side=`admin`.
