...
Carrier gateway configuration, quality and route behavior.
...
|---|---|---|
| F01 | General configuration | Required |
| F02 | Registration/security | Required |
| F03 | Capacity/line limit | Required |
| F04 | Rate limit/CPS | Required |
| F05 | Protection/failover | Required |
| F06 | Caller number pool where supported | Required |
| F07 | Signaling/register tracing controls | Required |
| F08 | ASR/ACD and current call count | Required |
| F09 | Registered/local IP | Required |
| F10 | Network quality | Required |
| F11 | Cost/rate references | Required |
| F12 | Audit | Required |

## VOS / Product Basis

VOS documents rate limiting, tracing, protect routes and online routing metrics. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Routing Gateway Detail**
...
- `page_viewed` with page=`routing-gateway-detail` and side=`admin`.
