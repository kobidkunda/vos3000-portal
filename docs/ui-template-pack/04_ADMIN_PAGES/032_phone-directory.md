...
Manage VOS phone/terminal objects.
...
| F03 | Lock state | Required |
| F04 | authorization type | Required |
| F05 | monthly consumption | Required |
| F06 | billing rate/private rate | Required |
| F07 | routing group | Required |
| F08 | DID/DDI | Required |
| F09 | softswitch | Required |
| F10 | registration type | Required |
| F11 | IP/port | Required |
| F12 | line/in/out limits | Required |
| F13 | online status | Required |

## VOS / Product Basis

VOS Phone Management documents these fields. Writes [VERIFY-API].
...
- `page_viewed` with page=`phone-directory` and side=`admin`.
