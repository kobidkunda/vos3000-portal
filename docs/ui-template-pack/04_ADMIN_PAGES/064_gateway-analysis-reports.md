...
Mapping/routing gateway and area analysis reports.
...
|---|---|---|
| F01 | Mapping gateway analysis | Required |
| F02 | Routing gateway analysis | Required |
| F03 | Mapping/routing area analysis | Required |
| F04 | Cross-area analysis | Required |
| F05 | time and gateway filters | Required |
| F06 | export | Required |

## VOS / Product Basis

VOS documents these Analysis Reports. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Gateway Analysis Reports**
...
- `page_viewed` with page=`gateway-analysis-reports` and side=`admin`.
