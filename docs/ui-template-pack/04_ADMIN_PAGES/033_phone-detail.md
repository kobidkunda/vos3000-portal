...
|---|---|
| Side | **Admin** |
| Product group | **Phones & Terminals** |
...
Configure a single phone/terminal and supplementary services.
...
|---|---|---|
| F01 | Registration credentials with secret masking/reset | Required |
| F02 | Caller-ID display | Required |
| F03 | Lock outgoing/incoming/all | Required |
| F04 | Authorization type | Required |
| F05 | Monthly min/max/service fee | Required |
| F06 | Private rate | Required |
| F07 | Account assignment | Required |
| F08 | DID/DDI | Required |
| F09 | Reverse charging | Required |
| F10 | Self-service password reset | Required |
| F11 | Call-in/out and line limits | Required |
| F12 | Caller/callee list groups | Required |
| F13 | Forwarding/DND/transfer controls | Required |
| F14 | Protocol/IP/media/DTMF/codec settings | Required |
| F15 | Routing strategies | Required |

## VOS / Product Basis

VOS documents phone management, supplementary services and advanced configuration. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`phone-detail` and side=`admin`.
