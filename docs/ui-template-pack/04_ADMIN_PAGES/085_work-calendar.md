...
Manage VOS working/non-working calendars where needed.
...
|---|---|---|
| F01 | Calendar name | Required |
| F02 | memo | Required |
| F03 | working/non-working periods | Required |
| F04 | usage references | Required |
| F05 | safe edit workflow | Required |

## VOS / Product Basis

VOS Work Calendar is documented. [VOS]/[VERIFY-API]
...
- `page_viewed` with page=`work-calendar` and side=`admin`.
