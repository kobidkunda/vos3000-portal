...
Complete ingress gateway configuration and telemetry.
...
|---|---|---|
| F01 | Overview | Required |
| F02 | Customer/account mapping | Required |
| F03 | Gateway type static/dynamic | Required |
| F04 | IP(s) and signaling port | Required |
| F05 | Line limit | Required |
| F06 | Routing gateway group/allow-forbid controls | Required |
| F07 | Process timeout | Required |
| F08 | Protect-route enable time | Required |
| F09 | Conversation limit | Required |
| F10 | Media proxy and RTP-interrupt settings | Required |
| F11 | Registered IP/status | Required |
| F12 | Current calls | Required |
| F13 | Network quality | Required |
| F14 | Audit history | Required |

## VOS / Product Basis

VOS documents these mapping-gateway fields. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Mapping Gateway Detail**
...
- `page_viewed` with page=`mapping-gateway-detail` and side=`admin`.
...
- [ ] All source requirements F01..F14 implemented or explicitly deferred with approval.
