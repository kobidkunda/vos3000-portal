...
Issue and control API access for customers/integrations.
...
|---|---|---|
| F01 | Client/customer | Required |
| F02 | key ID | Required |
| F03 | secret shown once | Required |
| F04 | scopes | Required |
| F05 | IP allowlist | Required |
| F06 | rate limit | Required |
| F07 | created/last-used | Required |
| F08 | expiry | Required |
| F09 | rotate/revoke | Required |
| F10 | request statistics | Required |
...
- `page_viewed` with page=`portal-api-clients` and side=`admin`.
