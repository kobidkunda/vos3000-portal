...
Financial balance controls with strict auditability.
...
| F02 | Portal wallet balance if separate | Required |
| F03 | Overdraft/credit | Required |
| F04 | Add payment | Required |
| F05 | Add credit | Required |
| F06 | Make-zero only for authorized roles | Required |
| F07 | Adjustment memo mandatory | Required |
| F08 | Before/after balance preview | Required |
| F09 | Dual-control/approval option above configured threshold | Required |
| F10 | Complete adjustment history | Required |

## VOS / Product Basis

VOS Payment supports Payment/Credit/Make Zero and historical records. [HYBRID]/[VERIFY-API]
...
**Left**
- Page title: **Customer Balance & Adjustments**
...
- `page_viewed` with page=`customer-balance-adjustments` and side=`admin`.
