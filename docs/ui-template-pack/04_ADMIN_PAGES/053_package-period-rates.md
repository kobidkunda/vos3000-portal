...
Define time-window-specific package rates.
...
|---|---|---|
| F01 | Period type | Required |
| F02 | begin/end date | Required |
| F03 | begin/end time | Required |
| F04 | period rate | Required |
| F05 | overlap validation | Required |
| F06 | calendar preview | Required |

## VOS / Product Basis

VOS Package Period Rate Management is documented. [VOS]/[VERIFY-API]
...
**Left**
- Page title: **Package Period Rates**
...
- `page_viewed` with page=`package-period-rates` and side=`admin`.
