...
|---|---|---|
| F01 | Event | Required |
| F02 | endpoint | Required |
| F03 | attempt | Required |
| F04 | HTTP status | Required |
| F05 | latency | Required |
| F06 | next retry | Required |
| F07 | payload preview with redaction | Required |
| F08 | manual retry if allowed | Required |
...
**Left**
- Page title: **Webhook Delivery Log**
...
- `page_viewed` with page=`webhook-delivery-log` and side=`client`.
