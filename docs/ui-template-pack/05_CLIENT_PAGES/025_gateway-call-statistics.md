...
Call outcome stats for one customer gateway.
...
|---|---|---|
| F01 | Total calls | Required |
| F02 | success | Required |
| F03 | callee rejected | Required |
| F04 | trunk/network errors where appropriate | Required |
| F05 | caller abandon | Required |
| F06 | average talk duration | Required |
| F07 | total call time | Required |
| F08 | time range | Required |
| F09 | drill to CDR | Required |

## VOS / Product Basis

VOS Gateway Status documents these outcome fields. Customer-safe projection is [HYBRID].
...
**Left**
- Page title: **Gateway Call Statistics**
...
- `page_viewed` with page=`gateway-call-statistics` and side=`client`.
