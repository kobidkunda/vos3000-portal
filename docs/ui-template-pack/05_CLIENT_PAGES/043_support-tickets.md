...
Customer support history and new ticket entry.
...
|---|---|---|
| F01 | Open/pending/resolved statuses | Required |
| F02 | category Billing/Routing/Quality/Technical/Rate/Payment/Other | Required |
| F03 | priority | Required |
| F04 | last update | Required |
| F05 | search/filter | Required |
| F06 | new ticket | Required |
...
- `page_viewed` with page=`support-tickets` and side=`client`.
...
- [ ] All source requirements F01..F06 implemented or explicitly deferred with approval.
