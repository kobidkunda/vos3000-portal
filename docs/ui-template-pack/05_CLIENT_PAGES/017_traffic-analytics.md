...
Understand call volume and minutes.
...
|---|---|---|
| F01 | Calls | Required |
| F02 | answered | Required |
| F03 | failed | Required |
| F04 | minutes | Required |
| F05 | spend | Required |
| F06 | ASR | Required |
| F07 | ACD | Required |
| F08 | PDD | Required |
| F09 | hour/day granularity | Required |
| F10 | destination breakdown | Required |
| F11 | gateway breakdown | Required |
| F12 | compare previous period | Required |
| F13 | export | Required |

## VOS / Product Basis

VOS has CDR Analysis and gateway performance; customer analytics are [HYBRID].
...
- `page_viewed` with page=`traffic-analytics` and side=`client`.
