...
|---|---|
| Side | **Client** |
| Product group | **Access & Account Security** |
| Route | `/app/settings/profile` |
| Page archetype | **DETAIL** |
| Data mode | **query** |
| Primary implementation phase | **P12 — Observability, Security Hardening, Backup & High Availability** |
| Source status | Product-spec derived; VOS-specific behavior must follow the basis below |

## Goal

Manage customer-facing profile data.
...
|---|---|---|
| F01 | Organization name | Required |
| F02 | billing/contact emails | Required |
| F03 | phone | Required |
| F04 | timezone | Required |
| F05 | default report timezone | Required |
| F06 | notification preferences | Required |
| F07 | VOS account ID read-only where appropriate | Required |
...
**Left**
- Page title: **Profile & Organization**
...
- `page_viewed` with page=`profile-organization` and side=`client`.
