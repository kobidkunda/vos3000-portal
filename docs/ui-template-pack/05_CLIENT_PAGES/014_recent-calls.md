...
|---|---|---|
| F01 | Most recent calls | Required |
| F02 | answer/failure badge | Required |
| F03 | caller/callee | Required |
| F04 | duration | Required |
| F05 | charge | Required |
| F06 | gateway | Required |
| F07 | termination reason | Required |
| F08 | open detail | Required |

## VOS / Product Basis

VOS Recent CDR is documented. [VOS]/[HYBRID]
...
- `page_viewed` with page=`recent-calls` and side=`client`.
