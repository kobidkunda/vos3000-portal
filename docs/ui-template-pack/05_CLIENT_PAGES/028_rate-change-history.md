...
Transparency for customer rate changes.
...
|---|---|---|
| F01 | Destination/prefix | Required |
| F02 | old rate | Required |
| F03 | new rate | Required |
| F04 | effective date | Required |
| F05 | published date | Required |
| F06 | filter upcoming/past | Required |
| F07 | download change file | Required |

## VOS / Product Basis

Rate history/effective publishing workflow is a [PORTAL] extension unless a supported VOS mechanism is verified.
...
**Left**
- Page title: **Rate Change History**
...
- `page_viewed` with page=`rate-change-history` and side=`client`.
