...
Create and manage customer API credentials.
...
|---|---|---|
| F01 | Key name | Required |
| F02 | key ID | Required |
| F03 | secret shown once | Required |
| F04 | scopes | Required |
| F05 | IP allowlist | Required |
| F06 | expiry | Required |
| F07 | last used | Required |
| F08 | rotate/revoke | Required |
| F09 | max active keys per account | Required |
...
- `page_viewed` with page=`api-keys` and side=`client`.
