...
Customer-visible API diagnostics.
...
|---|---|---|
| F01 | Timestamp | Required |
| F02 | method/path | Required |
| F03 | status | Required |
| F04 | latency | Required |
| F05 | request ID | Required |
| F06 | key name | Required |
| F07 | IP | Required |
| F08 | filter/export | Required |
| F09 | redact secrets and sensitive payload data | Required |
...
- `page_viewed` with page=`api-request-logs` and side=`client`.
