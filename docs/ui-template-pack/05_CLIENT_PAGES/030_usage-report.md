...
Calls, minutes and spend report.
...
|---|---|---|
| F01 | Date range | Required |
| F02 | group by day/hour/destination/gateway | Required |
| F03 | calls | Required |
| F04 | answered | Required |
| F05 | minutes | Required |
| F06 | charges | Required |
| F07 | ASR/ACD where applicable | Required |
| F08 | export | Required |
...
- `page_viewed` with page=`usage-report` and side=`client`.
