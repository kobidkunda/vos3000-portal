...
|---|---|---|
| F01 | Current VOS balance | Required |
| F02 | Available credit if applicable | Required |
| F03 | today consumption | Required |
| F04 | month spend | Required |
| F05 | low-balance threshold | Required |
| F06 | last payments | Required |
| F07 | Add Funds button | Required |
| F08 | balance trend from portal snapshots | Required |

## VOS / Product Basis

VOS account balance/today consumption are documented. Trend is [HYBRID].
...
- `page_viewed` with page=`balance-wallet` and side=`client`.
