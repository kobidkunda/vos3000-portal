...
|---|---|---|
| F01 | CDR exports | Required |
| F02 | rate sheets | Required |
| F03 | statements | Required |
| F04 | reports | Required |
| F05 | status ready/expired | Required |
| F06 | size/row count | Required |
| F07 | expiry and delete | Required |
...
- `page_viewed` with page=`downloads` and side=`client`.
