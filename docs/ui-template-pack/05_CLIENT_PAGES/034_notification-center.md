...
In-app service and commercial alerts.
...
|---|---|---|
| F01 | Low balance | Required |
| F02 | payment result | Required |
| F03 | gateway online/offline | Required |
| F04 | ASR/failure degradation | Required |
| F05 | rate change | Required |
| F06 | account expiry | Required |
| F07 | security events | Required |
| F08 | read/unread | Required |
| F09 | filter by type | Required |
| F10 | deep links | Required |
...
- `page_viewed` with page=`notification-center` and side=`client`.
