...
|---|---|
| Side | **Client** |
| Product group | **Reports & Downloads** |
...
|---|---|---|
| F01 | Choose report | Required |
| F02 | saved filters | Required |
| F03 | daily/weekly/monthly | Required |
| F04 | timezone | Required |
| F05 | recipient emails restricted to organization policy | Required |
| F06 | CSV/XLSX/PDF where supported | Required |
| F07 | pause/resume | Required |
| F08 | last/next run | Required |
...
- `page_viewed` with page=`scheduled-reports` and side=`client`.
