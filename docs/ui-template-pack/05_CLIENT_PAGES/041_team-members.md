...
Organization-level portal users.
...
|---|---|---|
| F01 | Name/email | Required |
| F02 | role | Required |
| F03 | status | Required |
| F04 | last login | Required |
| F05 | MFA state | Required |
| F06 | invite member | Required |
| F07 | resend/revoke invite | Required |
| F08 | disable/remove member | Required |
...
- `page_viewed` with page=`team-members` and side=`client`.
