...
Periodic usage and financial summary.
...
|---|---|---|
| F01 | Opening balance | Required |
| F02 | payments/credits | Required |
| F03 | call charges | Required |
| F04 | package/rent items if applicable | Required |
| F05 | closing balance | Required |
| F06 | minutes/calls | Required |
| F07 | date range | Required |
| F08 | download CSV/PDF where implemented | Required |

## VOS / Product Basis

VOS provides account balance/revenue/bill queries. Formal statement presentation is [HYBRID].
...
**Left**
- Page title: **Statements & Billing Summary**
...
- `page_viewed` with page=`statements-billing-summary` and side=`client`.
